-- Migration 002: Fix vector dimensions and update match_documents function
-- This migration fixes the vector dimension mismatch and improves the similarity search
...
-- Recreate the vector_embeddings table with the correct dimension for Gemini embedding-001
...
-- Create improved match_documents function with flexible vector dimensions
...
COMMENT ON FUNCTION match_documents(vector, float, int) IS 'Vector similarity search function for RAG system using cosine similarity'; 